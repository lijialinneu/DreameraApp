...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/neu.dreamerajni/databases/";
...
//        dbExist = false;
        if (dbExist) {
            // 数据库已存在，do nothing.
            System.out.println("asdf donothing");
        } else {
            // 创建数据库
            try {
                ...
                System.out.println("asdf "+ DB_PATH);
                System.out.println("asdf " + DB_NAME);
...
//        System.out.println("asdf " + checkDB);
